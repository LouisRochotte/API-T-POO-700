defmodule MiniProject01Web.WorkingtimesControllerTest do
  use MiniProject01Web.ConnCase

  alias MiniProject01.Data
  alias MiniProject01.Data.Workingtimes
  ...
  def fixture(:workingtimes) do
    {:ok, workingtimes} = Data.create_workingtimes(@create_attrs)
    workingtimes
  end
